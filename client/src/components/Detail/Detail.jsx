      ...
      {Object.keys(detail).length === 0 ? (
        ...
        <main className={s.main}>
          ...
          <div className={s.right}>
            <h3>{detail.name}</h3>
            <hr />
            <span>Rating: <p>{detail.rating}</p></span>
            <hr />
            <p className={s.description}>{detail.description}</p>
            <hr />
            <span>Creado el: <p>{detail.released}</p></span>
            <hr />
            <span>Generos: <p>{detail.genres.join(", ")}</p></span>
            <hr />
            <span>Plataformas: <p>{detail.platforms.join(", ")}</p></span>
          </div>
        </main>
      </div>
      )}
